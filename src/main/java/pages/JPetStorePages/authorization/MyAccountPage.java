...
public class MyAccountPage extends BasePage {
    ...
    private final By saveAccButton = By.xpath("//input[@name='editAccount']");
    private final By myOrdersLink = By.xpath("//a[contains(text(), 'Orders')]");
    ...
    public void clickOnSaveAccButton() {
        driver.findElement(saveAccButton).click();
    }
